```
docker run --name mysql -v /data/release/gengleiming_config/share/mysql/my.cnf:/etc/mysql/my.cnf -v /data/store/mysql:/data/store/mysql -v /data/logs/mysql/mysql.log:/var/log/mysqld.log -e MYSQL_ROOT_PASSWORD=123456 -p 3306:3306 -d mysql:5.7
```
```
